...
import guoyang_liu_exercise2.BasePlusCommissionEmployee;
import guoyang_liu_exercise2.CommissionEmployee;
import guoyang_liu_exercise2.HourlyEmployee;
   ...
   public static void main(String[] args) {
     ...
     // Interface polymorphism
      ...
      Payable[] payableObjects = new Payable[] {
         ...
         (Payable) new CommissionEmployee("Kevin", "Durant", "333-33-3333", 55000,0.1),
